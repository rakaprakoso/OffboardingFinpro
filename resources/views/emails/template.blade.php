            ...
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #e6a501;">
                            <div
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 15px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('/images/email/images/image-5.png') }}"
                                                                            alt="Logo" title="Logo"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1
                                                                style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Raleway',sans-serif; font-size: 48px;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 30px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="color: #333333; line-height: 130%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 130%;">
                                                                    <strong><span
                                                                            style="font-size: 16px; line-height: 20.8px;">Dear @yield('recipient'),</span></strong>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 130%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 130%;"><span
                                                                        style="font-size: 16px; line-height: 20.8px; font-family: Lato, sans-serif; text-align:justify">
                                                                        @yield('message')
                                                                    </span></p>
                                                            </div>
                                                        </td>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_15" style="font-family:'Open Sans',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 20px 15px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span
                                                                        style="font-size: 16px; line-height: 25.6px; font-family: Lato, sans-serif;">Please,
                                                                        consider this as an confirmation email. If you
                                                                        have any questions contact us with this link
                                                                       <a href="mailto:info@indosat.com">
                                                                            <span
                                                                                style="text-decoration: underline; line-height: 25.6px; color: #e67e23; font-size: 16px;">info@indosat.com
                                                                            </span>
                                                                       </a>
                                                                    </span>
                                                                </p>
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 30px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="color: #333333; line-height: 160%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 16px; line-height: 25.6px; font-family: Lato, sans-serif;">Terima Kasih</span>
                                                                </p>
                                                            </div>
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://facebook.com/"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('/images/email/images/image-1.png') }}"
                                                                                            alt="Facebook"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://twitter.com/"
                                                                                        ...
                                                                                        <img src="{{ asset('/images/email/images/image-4.png') }}"
                                                                                            alt="Twitter"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://linkedin.com/"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('/images/email/images/image-2.png') }}"
                                                                                            alt="LinkedIn"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://instagram.com/"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('/images/email/images/image-3.png') }}"
                                                                                            alt="Instagram"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="color: #828080; line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 160%;">Jalan Medan Merdeka Barat No. 21, Jakarta 10110 | Indonesia Telp : (62-21) 3000 30001 | Website : indosatooredoo.com</p>
                                                                <p style="font-size: 14px; line-height: 160%;">Indosat Ooredoo | Privacy Policy</p>
                                                            </div>
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="color: #828080; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">&copy;
                                                                   Indosat Ooredoo. All Rights Reserved.</p>
                                                            </div>
